...
/**
 * Zephyr Lily block
 * A small herb that generates in plains and plateau biomes
 */
public class BlockZephyrLily extends BlockBush
{
    // Slightly larger than vanilla flowers (0.2-0.8 vs 0.3-0.7, 0.5 high vs 0.4 high)
    protected static final AxisAlignedBB LILY_AABB = new AxisAlignedBB(0.2D, 0.0D, 0.2D, 0.8D, 0.5D, 0.8D);

    public BlockZephyrLily()
    {
        super();
        setHardness(0.0F);
