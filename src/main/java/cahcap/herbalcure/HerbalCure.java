package cahcap.herbalcure;

import cahcap.herbalcure.client.proxy.ClientProxy;
import cahcap.herbalcure.common.creativetab.HerbalCureCreativeTab;
import cahcap.herbalcure.common.proxy.CommonProxy;
import cahcap.herbalcure.server.proxy.ServerProxy;
...
public class HerbalCure
{
     ...
     */
    @SidedProxy(
        clientSide = "cahcap.herbalcure.client.proxy.ClientProxy",
        serverSide = "cahcap.herbalcure.server.proxy.ServerProxy"
    )
